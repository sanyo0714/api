...
local function common(request_body)
    --request_body "c2VsZWN0ICogZnJvbSB0X3NlcnZpY2U7"  select * from t_service;
    local sql, in_len, out_len = base64.decode(request_body)
...
local function get_area(request_body)
    ...
    local data, in_len, out_len = base64.decode(request_body)
